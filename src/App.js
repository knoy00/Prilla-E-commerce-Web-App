...
import men_banner from './Components/Assets/b&w1.jpg'
import women_banner from './Components/Assets/yellow2.png'
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path='/kids' element={<Shopcontent banner={kids_banner} category="kid"/>}/>
